...
# plot a whisker for each solution algorithm
# to look at the different data_sets: change fully_synthetic to: "close_maxima", "heterogen", "invalid_branches", "no_deletes"

dir_path = "./results/experiments/fully_synthetic/"
combined_data = []
gen_data = []
